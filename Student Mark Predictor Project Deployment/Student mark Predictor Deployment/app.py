...
model = joblib.load(r"C:\Users\abhir\Downloads\Student Mark Predictor Project Deployment\Student Mark Predictor Project Deployment\Student mark Predictor Deployment/student_mark_predictor")
